...
select * from fireCallsPartitioned where City is null;
...
select count(*) from fireCallsPartitioned as number_records
...
UPDATE fireCallsPartitioned set Call_Type_Group ='Non Life-threatning' WHERE Call_Type_Group is NULL
