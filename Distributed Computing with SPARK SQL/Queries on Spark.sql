...
SELECT * from fireIncidents WHERE `Incident Date` ='2016-04-04'
...
SELECT * from fireIncidents
 WHERE `Incident Date` LIKE'%%%%-04-04'
  OR `Incident Date` LIKE'%%%%-09-27'
...
Select count(`Ignition Cause`) from fireIncidents 
